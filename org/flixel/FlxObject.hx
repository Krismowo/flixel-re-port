...
class FlxObject extends FlxBasic
{
	...
	override public function drawDebug(Camera : FlxCamera = null) : Void
	{
		...
		var boundingBoxWidth : Int = ((width != as3hx.Compat.parseInt(width))) ? Std.int(width) : Std.int(width - 1);
		var boundingBoxHeight : Int = ((height != as3hx.Compat.parseInt(height))) ? Std.int(height) : Std.int(height - 1);
