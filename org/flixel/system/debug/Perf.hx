...
class Perf extends FlxWindow
{
	...
	public function new(Title : String, Width : Float, Height : Float, Resizable : Bool = true, Bounds : Rectangle = null, BGColor : Int = 0x7f7f7f7f, TopColor : Int = 0x7f000000)
	{
		...
		_flixelUpdate = new Array<Dynamic>();
		_flixelUpdateMarker = 0;
		_flixelDraw = new Array<Dynamic>();
		_flixelDrawMarker = 0;
		_flash = new Array<Dynamic>();
		_flashMarker = 0;
		_activeObject = new Array<Dynamic>();
		_objectMarker = 0;
		_visibleObject = new Array<Dynamic>();
	...
	public function update() : Void
	{
		...
		if (_updateTimer > updateEvery)
		{
			...
			output += as3hx.Compat.toFixed(as3hx.Compat.parseFloat((System.totalMemory * 0.000000954)), 2) + "MB\n";
