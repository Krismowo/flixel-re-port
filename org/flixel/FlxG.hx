...
class FlxG
{
    ...
    /**
		 ...
		 */
    public static function playMusic(Music:String , Volume : Float = 1.0) : Void
    {
        if (music == null)
        {
            music = new FlxSound();
    ...
    /**
		 ...
		 */
    public static function loadSound(EmbeddedSound:String = null, Volume : Float = 1.0, Looped : Bool = false, AutoDestroy : Bool = false, AutoPlay : Bool = false, URL : String = null) : FlxSound
    {
    ...
    /**
		 ...
		 * @return	A <code>FlxSound</code> object.
		 */
    public static function play(EmbeddedSound:String, Volume : Float = 1.0, Looped : Bool = false, AutoDestroy : Bool = true) : FlxSound
    {
    ...
    public static function pauseSounds() : Void
    {
        ...
        var i : Int = 0;
        var sound : FlxSound;
        var l:Int = Std.int(sounds.length);
        while (i < l)
        {
            sound = try cast(sounds.members[i++], FlxSound) catch(e:Dynamic) null;
    ...
    {
        return Reflect.hasField(_cache, Key);
    }
    ...
    public static function addBitmap(Graphic:String, Reverse : Bool = false, Unique : Bool = false, Key : String = null) : BitmapData
    {
		...
		trace(Key + " IS THE KEY OF THE THING");
		//trace("WE HAVE THE ACTUAL THING RIGHT??? ")
