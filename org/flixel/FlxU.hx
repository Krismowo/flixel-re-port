...
class FlxU
{
    ...
    {
        return as3hx.Compat.parseInt((Std.int(((Alpha > 1)) ? Alpha : (Alpha * 255)) & 0xFF) << 24 | (Red & 0xFF) << 16 | (Green & 0xFF) << 8 | (Blue & 0xFF));
    }
    ...
    public static function makeColorFromHSB(Hue : Float, Saturation : Float, Brightness : Float, Alpha : Float = 1.0) : Int
    {
        ...
        return as3hx.Compat.parseInt((Std.int(((Alpha > 1)) ? Alpha : (Alpha * 255)) & 0xFF) << 24 | as3hx.Compat.parseInt(red * 255) << 16 | as3hx.Compat.parseInt(green * 255) << 8 | as3hx.Compat.parseInt(blue * 255));
    }
