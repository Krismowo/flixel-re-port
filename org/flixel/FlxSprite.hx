...
/**
	 ...
	 * @author	Adam Atomic
	 */
@:bitmap("org/flixel/data/default.png")
class ImgDefault extends BitmapData {}
...
class FlxSprite extends FlxObject
{
	...
	//Create the brush and canvas
	{
		...
		var columns : Int = Std.int(FlxU.ceil(Rotations / rows));
		width = max * columns;
		height = max * rows;
		...
		frameWidth = Std.int(frameHeight = Std.int(width = height = max));
		resetHelpers();
		if (AutoBuffer)
		{
			width = brush.width;
